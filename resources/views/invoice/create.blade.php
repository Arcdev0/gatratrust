        ...
        <div class="row justify-content-end mt-4">
            <div class="col-md-4">
                <table class="table table-sm">
                    ...
                    <tr>
                        <th>Discount</th>
                        <td><input type="number" name="discount" id="discount" class="form-control text-end" value="0">
                        </td>
                    </tr>
                    <tr>
                        <th>Down Payment</th>
                    ...
                    <tr class="table-light">
                        <th>Net Total</th>
                        <td><input type="text" name="net_total" id="netTotal" class="form-control text-end" readonly>
                        </td>
                    </tr>
                </table>
            </div>
