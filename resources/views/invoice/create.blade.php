                    ...
                    <div class="row justify-content-end mt-4">
                        <div class="col-md-4">
                            <table class="table table-sm">
                                <tr>
                                    <th>Gross Total</th>
                                    <td><input type="text" name="gross_total" id="grossTotal" class="form-control text-end" readonly></td>
                                </tr>
                                <tr>
                                    <th>Discount</th>
                                    <td><input type="number" name="discount" id="discount" class="form-control text-end" value="0"></td>
                                </tr>
                                <tr>
                                    <th>Down Payment</th>
                                    <td><input type="text" name="down_payment" id="downPayment" class="form-control text-end" value="Rp. 0"></td>
                                </tr>
                                <tr>
                                    <th>Tax (%)</th>
                                    <td><input type="number" name="tax" id="tax" class="form-control text-end" value="0"></td>
                                </tr>
                                <tr class="table-light">
                                    <th>Net Total</th>
                                    <td><input type="text" name="net_total" id="netTotal" class="form-control text-end" readonly></td>
                                </tr>
                            </table>
                        </div>
                    </div>
